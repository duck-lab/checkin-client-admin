  ...
  render() {
    ...
    const content = (
      <div className={styles.pageHeaderContent}>
        <p>
          组织：组织是活动/事件的承办者，一个活动/事件要属于一个组织，并且只有这个组织的管理者可以管理。同时组织也可以同其他组织一起来举行某个活动。
        </p>
        <div className={styles.contentLink}>
          <Link to="/organization/create">
            <img alt="/" src="https://gw.alipayobjects.com/zos/rmsportal/MjEImQtenlyueSmVEfUD.svg" /> 创建组织
          </Link>
          {/* <a>
